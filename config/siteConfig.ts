...
export const SITE_CONFIG = {
  ...
  description:  "Portfolio of Devesh Sawant, AI Engineer and Full Stack Developer specializing in Agentic AI, Knowledge Graphs, RAG pipelines, LLM Engineering, FastAPI, React, and intelligent systems.",
  url: DOMAIN_URL ?? "http://localhost:3000",
  siteName: "Devesh Sawant",
  keywords: ["Devesh Sawant","AI Engineer","Full Stack Developer","Agentic AI","LLM Engineer","Knowledge Graph","Neo4j","FastAPI","React","Python","RAG","Generative AI","Intelligent Systems","Portfolio"],
