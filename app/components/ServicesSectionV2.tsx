...
const services = [
  { name: "Agentic AI", src: "magic-wand" },
  { name: "RAG Pipelines", src: "planet" },
  { name: "Full Stack Apps", src: "paint-bucket" },
  { name: "Knowledge Graphs", src: "web" },
  { name: "Cloud Deployment", src: "cube" },
  { name: "System Design", src: "world" },
];
            ...
            {tech.map(({ name, icon: TechIcon }) => (
              <MotionLi key={name} variants={element}>
                <div className="group relative">
                  ...
                  >
                    <TechIcon size={28} className="text-black" />
                  </label>
                  {/* optional tooltip */}
