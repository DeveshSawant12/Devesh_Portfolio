...
import profilePhoto from "@/app/images/Deva.jpg"
      ...
      <div className="inside-container-small">
        ...
        >
          <div className="flex w-fit items-center gap-3 p-2 max-lg:justify-center">
            <div className="relative h-12 w-12 overflow-hidden rounded-full ring-6 ring-slate-200">
              <Image src={profilePhoto} alt="Devesh Sawant" fill sizes="80px" className="object-cover" />
            </div>
            <div className="flex flex-col items-start text-sm whitespace-nowrap text-slate-700">
              <h2 className="font-medium text-slate-900">Devesh Sawant</h2>
          ...
          <div className="flex flex-col items-center gap-4 max-lg:items-center">
            ...
            <Text className="max-w-2xl text-center text-balance">
              Looking for a developer who can build modern websites or AI-powered applications? Let's create something impactful together.
            </Text>
          </div>
