...
import profilePhoto from "@/public/assets/devesh.jpg"
...
export const CallToActionButton = () => {
  ...
  return (
    <a href={SITE_NAP.profiles.github} target="_blank" rel="noopener" aria-label="Devesh Sawant's GitHub">
      <MotionButton
        initial="initial"
        animate="animate"
        whileHover="hover"
      ...
      >
        ...
        <div className="relative flex items-center gap-1">
          ...
          <div className="relative h-7 w-7 rounded-full">
            <Image src={profilePhoto} alt="Profile photo of Devesh Sawant" fill sizes="50px" className="rounded-full object-cover ring-2 ring-white/75" />
          </div>
